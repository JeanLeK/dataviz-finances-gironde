...
export function Home({
    ...
    return React.createElement('article', {className: 'home'},
        ...
        //ajout d'une bannière pour indiquer que le code est disponible sur github
            React.createEement('div', {id: 'banner'},
            React.createElement('a', {href: 'https://github.com/datalocale/dataviz-finances-gironde'},
            React.createElement(Markdown, {}, `Code disponible sur Github`)
